...
public class Coupon {
    ...
    @Builder
    private Coupon(String title, CouponType couponType, Integer totalQuantity, int issuedQuantity, int discountAmount, int minAvailableAmount, LocalDateTime dateIssueStart, LocalDateTime dateIssueEnd) {
        this.title = title;
